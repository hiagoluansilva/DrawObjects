...
public class MyOval extends MyShape{
    ...
    public MyOval(int x1, int y1, int x2, int y2, Color myColor, Color myColor2) {
    ...
    public void draw(Graphics paramGraphics) 
    {
        ...
        paramGraphics.fillOval(getX1(), getY1(), getX2(), getY2());
        paramGraphics.setColor(getMyColor());
        paramGraphics.drawOval(getX1(), getY1(), getX2(), getY2());
    }
